    ...
    <div>
      ...
      <div className="w-full max-w-[1440px] flex flex-col lg:flex-row gap-[30px] px-4 lg:px-0">
        ...
        <div className="relative w-full lg:w-[707px] h-[400px] lg:h-[682px] flex justify-center">
          <Image src={require('../../../public/image/couple-image.png')} alt="couple" className="object-cover" style={{ width: "100%", height: "100%" }} /> 
        </div>

        {/* Text Section */}
        <div className="w-full pb-10 sm:pb-0 lg:w-[573px] h-auto flex flex-col gap-[20px] justify-center items-center lg:items-start text-center lg:text-left mt-[20px] lg:mt-0">
