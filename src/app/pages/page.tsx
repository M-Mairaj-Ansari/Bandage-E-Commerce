            ...
            <div className="relative">
                ...
                <div className="container relative mx-auto px-4 py-12 flex flex-col md:flex-row gap-8 font-Montserrat">
                    ...
                    <div className="flex-1">
                        <div className="relative">
                            <Image
                                src={require('../../../public/image/sofa-img.jpg')}
                                alt="Product Image"
                        ...
                        <div className="flex mt-4 gap-4">
                            <Image
                                src={require('../../../public/image/chair-img.jpg')}
                                alt="Thumbnail 1"
                            ...
                            />
                            <Image
                                src={require('../../../public/image/sofa-img-1.jpg')}
                                alt="Thumbnail 2"
                                className="rounded-md cursor-pointer hover:ring-2 hover:ring-blue-500"
                                width={100}
                                height={100}
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-6">
                            <div className="flex items-center gap-2 mt-2">
                                <span className="h-6 w-6 rounded-full bg-[#23A6F0] border border-gray-300 cursor-pointer"></span>
                                <span className="h-6 w-6 rounded-full bg-[#2DC071] border border-gray-300 cursor-pointer"></span>
                                <span className="h-6 w-6 rounded-full bg-[#E77C40] border border-gray-300 cursor-pointer"></span>
                                <span className="h-6 w-6 rounded-full bg-[#252B42] border border-gray-300 cursor-pointer"></span>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                <Image src={require('../../../public/image/heart.png')} alt="heart" className="w-[17.5px] h-[15.63px] cursor-pointer text-[#252B42]" />
                                <Image src={require('../../../public/image/cart.png')} alt="cart" className="w-[19px] h-[19px] cursor-pointer text-[#252B42]" />
                                <Image src={require('../../../public/image/eye.png')} alt="eye" className="w-[16px] h-[11px] cursor-pointer text-[#000000]" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* ProductsCrads*/}
                <div className="w-full h-auto flex flex-col  sm:flex-row sm:justify-around sm:top-[900px] sm:bottom-[70px] sm:items-center">
                    <span className="font-Montserrat font-semibold text-[14px] leading-[24px] flex justify-center text-[#737373] mb-4 sm:mb-0">
                        Description
                    </span>
                    <span className="font-Montserrat font-semibold text-[14px] leading-[24px] flex justify-center text-[#737373] mb-4 sm:mb-0">
                ...
                <div className="flex flex-col lg:flex-row gap-6 px-4 md:px-8 py-8 md:py-12 items-center justify-center">
                    ...
                    <div className="w-full lg:w-[323px] h-auto flex-shrink-0 rounded-lg overflow-hidden">
                        <Image src={require('../../../public/image/home-img.png')} alt="Interior Design" width={323} height={400} className="object-cover" />
                    </div>
